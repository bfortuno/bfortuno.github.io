...
The reusable Nerfies-style page template for either a featured paper or a standout project: content schema, layout sections, and the `/projects/<slug>` dynamic route. Established in the `project-page-template` change.
