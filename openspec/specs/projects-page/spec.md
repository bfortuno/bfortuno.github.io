...
The projects route: a card grid sourced from structured data, with cards conditionally linking to a dedicated project/paper page from the `project-page-template` capability. Established in the `projects-page` change.
